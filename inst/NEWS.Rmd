...
### NEW FEATURES AND FUNCTIONS
     ...
     * sequences.mutation.base(): Added function to calculate proportions of silent mutations from nucleotide A to nucleotide B. Now, the nucleotide changes of the mutated position, but also the nucleotide distributions next to the mutated position (-3 to +3) can be analysed.
